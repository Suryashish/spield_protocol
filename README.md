...
[![Demo Video](https://img.shields.io/badge/▶_Demo_Video-YouTube-ff0000?style=for-the-badge)](https://youtu.be/CPBsyChmcT4?si=eSd8Hq0rQLUwZNAY)
[![X / Twitter](https://img.shields.io/badge/Follow-@spield__-000000?style=for-the-badge&logo=x)](https://x.com/spield_)

**🌐 [Live App](https://spield-protocol.vercel.app/) · ▶️ [Demo Walkthrough](https://youtu.be/CPBsyChmcT4?si=eSd8Hq0rQLUwZNAY) · 🐦 [@spield_](https://x.com/spield_) · 💻 [GitHub](https://github.com/Suryashish/spield_protocol)**
...
| **Verified on-chain transactions** | **164** (every hash confirmed on Horizon) |
| **Products exercised** | Fixed-Rate Vault deposits, wrapper mints (PT+YT), market swaps, yield claims, add-liquidity |

**Activity breakdown (all on-chain verified):**

| Action | Count |
| --- | --- |
| Vault deposits (lock fixed rate) | 30 |
| Wrapper mints (PT + YT) | 28 |
| Market swaps (buy PT) | 37 |
| Yield claims | 7 |
| Add-liquidity | 4 |
| USDC funding transfers | 56 |
| Market seed (liquidity) | 2 |
...
- **User addresses & feedback sheet:** [User addresses + feedback (Google Sheets)](https://docs.google.com/spreadsheets/d/1zb5vYk3DO7ArHHYuLLj-_hXUoXemz4GD0q-6TFErQaU/edit?gid=0#gid=0)
...
- **In-repo, copy-friendly records:**
  - [`TESTNET_ACCOUNTS.md`](./TESTNET_ACCOUNTS.md) — all 55 accounts (addresses + keys)
  - [`TESTNET_TRANSACTIONS.md`](./TESTNET_TRANSACTIONS.md) — every transaction with a clickable
    explorer link (incl. a copy-friendly full-URL table)

> Reproducible: the activity was generated by [`contract/spield/scripts/testnet_activity.sh`](./contract/spield/scripts/testnet_activity.sh)
> (checkpointed/resumable) and the pool deepened by [`seed_market.sh`](./contract/spield/scripts/seed_market.sh).
...
> All future feedback-driven changes will continue to be shipped as tracked commits and linked here.
...
├── TESTNET_ACCOUNTS.md      # 55 demo accounts (proof of users)
├── TESTNET_TRANSACTIONS.md  # 164 verified transactions (proof of activity)
...
| Demo video | ✅ | [YouTube walkthrough](https://youtu.be/CPBsyChmcT4?si=eSd8Hq0rQLUwZNAY) |
| Proof of 50+ users | ✅ | [55 accounts](./TESTNET_ACCOUNTS.md) · [activity sheet](https://docs.google.com/spreadsheets/d/14weww6LTWfQszC_9Uo9FvCESVJbaTdbw_H5WZQXbNnc/edit?gid=0#gid=0) |
| Transaction activity proof | ✅ | [164 verified txs](./TESTNET_TRANSACTIONS.md) |
| Updated README & documentation | ✅ | This file + [`/docs`](./docs) |
...
[🌐 App](https://spield-protocol.vercel.app/) · [▶️ Demo](https://youtu.be/CPBsyChmcT4?si=eSd8Hq0rQLUwZNAY) · [🐦 X](https://x.com/spield_) · [💻 GitHub](https://github.com/Suryashish/spield_protocol)
