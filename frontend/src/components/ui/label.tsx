...
function Label({
  ...
  return (
    <LabelPrimitive.Root
      data-slot="label"
      className={cn(
        // No size of its own: a field label inherits the row it sits in, so
        // putting `eyebrow` on that row restyles the label with it instead of
        // losing to a hard-coded `text-sm` here.
